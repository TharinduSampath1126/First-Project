...
function Section6() {
  ...
  return (
    <div className=' mt-10 '>
        ...
        <div>
            <img src={Bell} alt="" className='absolute left-[1180px] top-[2880px] hidden lg:block'/>
        </div>
        ...
        */}
        ...
        <div>
            <img src={PaiChart} alt="PaiChart" className='absolute left-[1030px] top-[3860px] hidden lg:block'/>
        </div> 

        <div>
            <img src={Star} alt="Star" className='absolute left-[130px] top-[3730px] hidden lg:block'/>
        </div>

        
        

        <div className='grid grid-cols-1  justify-self-center lg:grid-cols-2 gap-10 mb-20 md:justify-self-center lg:justify-self-center font-[400] mt-30  '>
            <div className='container mx-auto py-5 md:w-[572px] md:h-[459px] lg:w-[572px] lg:h-[459px] rounded-[20px] bg-[#F4F4F4] place-content-center space-y-10'>
            ...
            <div className='container mx-auto py-5 md:w-[572px] md:h-[459px] lg:w-[572px] lg:h-[459px] rounded-[20px] bg-[#1090CB] place-content-center space-y-10 '>
