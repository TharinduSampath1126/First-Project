    ...
    <div className=' '>
      <div className=' h-[534px] bg-[#E8F4FA]  grid place-items-center font-[400] '>
        <div className=' grid gap-20'>
            <div>
              <p className='font-poppins font-semibold text-[30px] leading-[170%] tracking-normal text-center ml-[10px] mr-[10px]'>Lorem Ipsum <span className='font-poppins font-semibold text-[30px] leading-[170%] tracking-normal text-center'>is simply dummy <br /> text of the printing.</span> </p>
            </div>
