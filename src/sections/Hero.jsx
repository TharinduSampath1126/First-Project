...
export default function Hero() {
  return (
    <section id='hero' className='bg-[#1090CB]/10 flex items-center justify-center relative mx-auto '>
        ...
        <div className='max-w-[1536px] flex flex-col-reverse md:flex-row items-center justify-between  px-6 sm:px-10 md:px-16 lg:pl-[123px] py-0 md:pb-0 relative'>
          ...
          <img src={blueshape} alt="Blue Shape" className='  absolute hidden lg:block top-[220px] right-0'/>
          ...
          <div className=" w-full md:w-1/2 h-150 text-center md:text-left mt- md:mt-[102px] md:ml-5 items-center lg:mt-45 lg:py-0 md:py-0 py-25 ">
            ...
            <div className="grid lg:flex lg:flex-row items-center gap-4 sm:gap-6 justify-center md:justify-start mt-18 font-[400] ">
              <button className="bg-[#1090CB] w-[250px] h-[50px] sm:w-[140px] sm:h-[40px] md:w-[193px] md:h-[51px] lg:w-[193px] lg:h-[51px] text-white sm:px-5 sm:py-2 md:px-6 md:py-3 lg:px-6 lg:py-3 rounded-md text-sm sm:text-base shadow-md hover:bg-[#0d7fb0] transition">
                  Contact us
              </button>
              <button className="border border-[#1090CB] text-[#1090CB] w-[250px] h-[50px]  sm:w-[140px] sm:h-[40px] md:w-[193px] md:h-[51px] lg:w-[193px] lg:h-[51px] sm:px-5 sm:py-2 md:px-6 md:py-3 lg:px-6 lg:py-3 rounded-md text-sm sm:text-base bg-white shadow-sm hover:bg-[#f0f9ff] transition">
                    View more
              </button>
            </div>
          </div>
